...
categories:
  - Daily
image: /image/斜拋網頁.png
---

[Github連結](https://github.com/yih-0118/physic.github.io)

- 斜拋實驗模擬
  -   [part1](https://yih-0118.github.io/physic.github.io/Projectile%20Motion%20Simulation%20pr1/)
  -   [part2](https://yih-0118.github.io/physic.github.io/Projectile%20Motion%20Simulation%20pr2/)
...
3. 飛行時間： $\frac{2  vy_0}{g}$ $ = $ $\frac{2  v_0\sin\theta}{g}$ 
4. 水平位置隨時間的變化：$\ x$ $=$ $x_0+v_x$ $_0$ $\times$ $t$
5. 鉛直位置隨時間的變化：
